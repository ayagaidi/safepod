...
class ReturnsController extends Controller
{
    ...
    {
        $exchange = exchange::with(['users'])
            ->where('exchangesnumber', $request->exchangesnumber)
            ->first();
        ...
        $exchangeItems = exchangeitem::with(['products', 'grades', 'sizes'])
            ->where('exchanges_id', $exchange->id)
            ->get();
    ...
    public function returns()
    {
            ...
            $Returns = Returns::with(['grades', 'users','products','sizes', 'exchanges'])
