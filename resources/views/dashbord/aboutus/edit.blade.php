...
<div class="row small-spacing">
    <div class="col-md-12">
        <div class="box-content ">
            <h4 class="box-title"><a href="{{ route('aboutus') }}">{{trans('aboutus.aboutus')}}</a>/ {{trans('aboutus.editbtn')}}</h4>
        </div>
    </div>
    <div class="col-md-12">
        <div class="box-content row">
            <form method="POST" class="" action="" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea  id="summernote" name="dec" class="form-control @error('dec') is-invalid @enderror" value="" id="dec" placeholder=" " >{!!$ab->dec!!}</textarea> 
                        @error('dec')
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea  id="summernote2" name="decen" class="form-control @error('decen') is-invalid @enderror" value="" id="decen" placeholder=" " >{!!$ab->decen!!}</textarea> 
                        @error('decen')
                    <span class="invalid-feedback" style="color: red" role="alert">
                        {{ $message }}
                    </span>
